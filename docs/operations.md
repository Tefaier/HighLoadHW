...
у нас:
- 2* 10^6 заказов/день -> в минуту 1.39 * 10^3 заказов (см requirements.md)
...
1. БД - active/standby. standby сервер получает данные асинхронно
    ...
    Поскольку изначально обозначили ограниченный бюджет (см. requirements.md), active/standby выглядит более привлекательно, пусть и:
